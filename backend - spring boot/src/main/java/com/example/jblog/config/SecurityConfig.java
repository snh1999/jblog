...
<<<<<<< HEAD:backend - spring boot/src/main/java/com/example/jblog/config/SecurityConfig.java
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.context.event.EventListener;
import org.springframework.http.HttpMethod;
=======
>>>>>>> parent of 053d69ea (complete frontend):src/main/java/com/example/jblog/config/SecurityConfig.java
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers(HttpMethod.GET, "/api/group", "/api/group/**").permitAll();
                    auth.requestMatchers(HttpMethod.GET, "/api/post", "/api/post/**").permitAll();
